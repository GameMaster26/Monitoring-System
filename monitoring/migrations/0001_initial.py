    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brgy_id', models.ForeignKey(default=11, on_delete=django.db.models.deletion.CASCADE, related_name='patients_brgy', to='monitoring.barangay', verbose_name='Barangay')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day0', models.DateField(blank=True, default=datetime.date(2024, 9, 4), null=True, verbose_name='Day 0')),
                ('day0_arrived', models.BooleanField(default=False, verbose_name='')),
                ('day3', models.DateField(blank=True, default=datetime.date(2024, 9, 7), null=True, verbose_name='Day 3')),
                ('day3_arrived', models.BooleanField(default=False, verbose_name='')),
                ('day7', models.DateField(blank=True, default=datetime.date(2024, 9, 11), null=True, verbose_name='Day 7')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brgy_id', models.ForeignKey(db_column='brgy_id', default=11, on_delete=django.db.models.deletion.CASCADE, related_name='history_brgy', to='monitoring.barangay', verbose_name='Barangay Exposure')),
