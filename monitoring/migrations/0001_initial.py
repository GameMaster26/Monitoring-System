    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(default=datetime.date(2018, 2, 13), verbose_name='Birthday')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day0', models.DateField(default=datetime.date(2024, 7, 3), verbose_name='Day 0')),
                ('day0_arrived', models.BooleanField(default=False, verbose_name='')),
                ('day3', models.DateField(default=datetime.date(2024, 7, 6), verbose_name='Day 3')),
                ('day3_arrived', models.BooleanField(default=False, verbose_name='')),
                ('day7', models.DateField(default=datetime.date(2024, 7, 10), verbose_name='Day 7')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_registered', models.DateField(default=datetime.date(2024, 7, 1), verbose_name='Date Registered')),
                ('date_of_exposure', models.DateField(blank=True, default=datetime.date(2024, 6, 29), null=True, verbose_name='Date of Exposure')),
                ...
                ('status_of_animal', models.CharField(choices=[('Alive', 'Alive'), ('Dead', 'Dead'), ('Killed', 'Killed'), ('Lost', 'Lost')], default='Dead', max_length=20, verbose_name='Animal Status')),
                ...
                ('brgy_id', models.ForeignKey(db_column='brgy_id', on_delete=django.db.models.deletion.CASCADE, related_name='history_brgy', to='monitoring.barangay', verbose_name='Barangay of Exposure')),
