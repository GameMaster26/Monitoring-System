# Generated by Django 5.1 on 2024-09-15 07:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muni_id', models.ForeignKey(db_column='muni_id', default=1, on_delete=django.db.models.deletion.CASCADE, related_name='barangays', to='monitoring.municipality', verbose_name='Municipality Name')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(default=datetime.date(1989, 12, 2), verbose_name='Birthday')),
                ...
                ('brgy_id', models.ForeignKey(default=5, on_delete=django.db.models.deletion.CASCADE, related_name='patients_brgy', to='monitoring.barangay', verbose_name='Barangay')),
                ('muni_id', models.ForeignKey(default=6, on_delete=django.db.models.deletion.CASCADE, related_name='patients_muni', to='monitoring.municipality', verbose_name='Municipality')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day0', models.DateField(default=datetime.date(2024, 6, 5), verbose_name='Day 0')),
                ('day0_arrived', models.BooleanField(default=False, verbose_name='')),
                ('day3', models.DateField(default=datetime.date(2024, 6, 8), verbose_name='Day 3')),
                ('day3_arrived', models.BooleanField(default=False, verbose_name='')),
                ('day7', models.DateField(default=datetime.date(2024, 6, 12), verbose_name='Day 7')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_registered', models.DateField(default=datetime.date(2024, 6, 14), verbose_name='Date Registered')),
                ('date_of_exposure', models.DateField(blank=True, default=datetime.date(2024, 5, 26), null=True, verbose_name='Date of Exposure')),
                ...
                ('brgy_id', models.ForeignKey(db_column='brgy_id', default=47, on_delete=django.db.models.deletion.CASCADE, related_name='history_brgy', to='monitoring.barangay', verbose_name='Barangay Exposure')),
                ('muni_id', models.ForeignKey(db_column='muni_id', default=8, on_delete=django.db.models.deletion.CASCADE, related_name='history_muni', to='monitoring.municipality', verbose_name='Municipality of Exposure')),
