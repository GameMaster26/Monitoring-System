...
function init(){
    ...
    totalCasesControl.onAdd = function (map) {
        ...
        <div style="text-align: center;">
            <h2 style="color: red; margin: 0; font-size: ${isMobile ? '16px' : '24px'};">${totalCases}</h2> 
            <h4 style="color: black; margin: 0; font-size: ${isMobile ? '10px' : '14px'};">Total Patients</h4>  
        </div>
        `;
        div.style.backgroundColor = 'rgba(255, 255, 255, 0.9)'; // Slight transparency
        div.style.padding = isMobile ? '4px' : '8px'; // Smaller padding for mobile
        div.style.borderRadius = '6px'; // Rounded corners
        div.style.fontFamily = 'Arial, sans-serif';
        div.style.boxShadow = '0 0 5px rgba(0, 0, 0, 0.2)'; // Add a subtle shadow
        div.style.maxWidth = isMobile ? '100px' : '150px'; // Set max width to prevent it from becoming too large
        return div;
    };
